...
# Load the dataset
df = pd.read_csv("D:\Corona_NLP_train.csv", encoding='latin')

# Preprocess the data
stop_words = set(stopwords.words('english'))
df['cleaned_tweet'] = df['OriginalTweet'].apply(
...
def generate_sentiment_line_chart():
    ...
    sentiment_counts.loc[
        sentiment_counts['Sentiment'].isin(['Negative', 'Extremely Negative']), 'Sentiment'] = 'Negative'

    # Combine positive and extremely positive sentiments
    sentiment_counts.loc[
        sentiment_counts['Sentiment'].isin(['Positive', 'Extremely Positive']), 'Sentiment'] = 'Positive'
